...
public class SingleBucketView extends RelativeLayout {
    ...
    public void init(Context context) {
        ...
        bucketNo = (TextView) findViewById(R.id.bucket_no);
        bucketName = (TextView) findViewById(R.id.bucket_name);
    }

    public void setBgImgView(int rsc) {
        //수정 필요. 지금은 R.drawable 값 받아서 세팅해주는 상태.

        bgImg.setImageResource(rsc);
        // bgImg.setColorFilter(Color.parseColor("#BDBDBD"), PorterDuff.Mode.MULTIPLY);
    ...
    public void setBnameView(String name) {
        ...
        bucketName.setTextColor(Color.parseColor("#FFFFFF"));
    }
